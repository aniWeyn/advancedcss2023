<template>
  <div>
    ...
    <section class="visualsrudiocode">
      <h4>Other tips:</h4>
      <h5>Visual Studio Code Shortcuts</h5>
  ...
  data() {
    return {
      links: [
        ...
        { title: "How To Use GitHub", href: "www.youtube.com/watch?v=3Tn58KQvWtU" },
        ...
        { title: "css-selectors-cheatsheet", href: "frontend30.com/css-selectors-cheatsheet/" },
        { title: "audio", href: "developer.mozilla.org/en-US/docs/Web/HTML/Element/audio" },
        { title: "Using and citing sources", href: "i.ntnu.no/academic-writing/using-and-citing-sources" },
        { title: "Advice about writing", href: "i.ntnu.no/en/academic-writing/writing-tips" },
